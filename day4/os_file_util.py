...
# python your_script.py mkdir new_folder


# List directory contents:

# python your_script.py ls


# Remove a file or directory:

# python your_script.py rm file.txt


# Rename a file:

# python your_script.py rename oldname.txt newname.txt


# Copy a file or directory:

# python your_script.py cp file.txt copy.txt


# Move a file or directory:

# python your_script.py mv file.txt folder/


# Show current working directory:

# python your_script.py pwd


# Run a raw shell command:

# python your_script.py exec ls -la
